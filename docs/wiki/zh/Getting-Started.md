...
运行期覆盖:`MOSAIC_DATA_DIR`、`MOSAIC_RESULTS_DIR`、`MOSAIC_CACHE_DIR`、`MOSAIC_AGENT_DATA_CACHE_ENABLED`、`MOSAIC_AGENT_DATA_CACHE_DB`、`MOSAIC_AGENT_DATA_CACHE_READ_TTL_SECONDS`、`MOSAIC_AGENT_DATA_CACHE_MAX_ENTRIES`、`MOSAIC_PYTHON`、`MOSAIC_BENCHMARK_TICKER`。
